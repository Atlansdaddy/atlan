...
const SUITES = [
  ...
  ['Doc drift', 'test/docdrift.mjs', 'The docs\' factual claims asserted against the CODE: tab count and names from index.html, engine roster from agents.js and fleet.js, template list from the UI, plus the status-convention requirements. A full sweep on 2026-08-02 found drift in BOTH directions across three docs — prose cannot be made to stop rotting by asking people to be careful, so the commit that changes a count now fails instead of the next reader.'],
